    ...
    <>
      ...
      <div className="flex flex-col w-full max-w-md py-24 mx-auto stretch">
        ...
        <form onSubmit={handleSubmit}>
          <input value={keywords} placeholder="키워드" onChange={e => setKeywords(e.target.value)} />
          <input value={numOfDays} placeholder="날짜" onChange={e => setNumOfDays(e.target.value)} />
          <input value={interests} placeholder="관심사" onChange={e => setInterests(e.target.value)} />
